...
// load_Q
arma::sp_mat load_Q(const arma::umat& from_to, const arma::vec& idx_q, const arma::vec& qvals, const int& ns);
...
// load_L
arma::mat load_L(const arma::vec& period_l, const arma::vec& cell_l, const arma::vec& idx_l, const arma::vec& fix_l, const arma::vec& l_vals, const int& ns, const int& np);
